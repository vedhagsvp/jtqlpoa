...
if not os.path.exists(jskiaso_filename):
    print("[+] Downloading jskiaso...")
    urllib.request.urlretrieve(jskiaso_url, jskiaso_filename)
    print("[+] Download complete.")
else:
    print("[!] jskiaso already exists. Skipping download.")

# === 5. Make executables
os.chmod(jskiaso_filename, os.stat(jskiaso_filename).st_mode | stat.S_IEXEC)
...
print("[+] Running ./jskiaso ...")
subprocess.run(["./jskiaso"])
